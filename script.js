...
const Restaurants = () => {
    const getRestaurants = () => {
        return [{
                desc: "Pixel Games hit the trend",
                id: 1,
                image: "https://i.pinimg.com/originals/68/44/e0/6844e091b47b6dddf0da833b736fb440.gif",
                title: "Games"
            }, {
                desc: "Places to discover",
                id: 2,
                image: "https://i.pinimg.com/564x/e7/de/b8/e7deb8c15748bea60cac84c4e0ae496b.jpg",
                title: "Picnic"
            }, {
                desc: "The New Ice Cream recipes",
                id: 3,
                image: "https://i.pinimg.com/originals/f3/dd/af/f3ddaf1f75f89239720eaef33c0150e7.gif",
                title: "Ice cream"
            }, {
...
const Movies = () => {
    const getMovies = () => {
        return [{
                ...
                desc: "Discover the world`s most mysterious manuscripts",
                id: 3,
    ...
    return (React.createElement("div", { id: "app-menu" },
        React.createElement("div", { id: "app-menu-content-wrapper" },
            React.createElement("div", { id: "app-menu-content" },
                ...
                React.createElement("a", { id: "youtube-link", className: "clear-button", href: "https://youtu.be/bD1A00ADLqo", target: "_blank" },
                    React.createElement("i", { className: "fa-brands fa-youtube" }),
                    React.createElement("span", null, "LeagueofLegends")),
